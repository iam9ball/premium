  ...
  const handleToggle = (value: boolean) => {
   ...
   const handleCounter = useCallback((func: string) => {
    ...
    {(step == STEPS.IMAGE) && (bodyContent = (
      <div className="flex flex-col  gap-6">
      <Heading title="Upload your image" titleClassName="text-xl font-bold ml-4"/>
    <label htmlFor="image" className="flex flex-col relative items-center w-[50%] py-16 px-5 mx-auto mt-2 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-gray-900 dark:border-gray-700 rounded-xl" {...getRootProps()}>
